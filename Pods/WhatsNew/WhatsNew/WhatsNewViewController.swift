...
public class WhatsNewViewController: UIViewController {
    ...
    /// Label strings to animate through
    public var titleStrings: [String] = ["What's New"] {
        didSet {
            titleLabel?.titles = titleStrings
        }
    }
    ...
    @IBOutlet private weak var titleLabel: AnimatedLabel!
